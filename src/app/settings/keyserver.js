        ...
        <form className="form mb-4">
          ...
          <div className="form-group">
            <div className="custom-control custom-checkbox">
              ...
              <label className="custom-control-label" htmlFor="keyserverTOFULookup"><span>{l10n.map.keyserver_tofu_lookup}</span>. <a href="https://github.com/imtoiteu/securemail/blob/internal-stable-v1/docs/internal/ADMIN_PUBLIC_KEY_MANAGEMENT_VI.md" target="_blank" rel="noopener noreferrer">{l10n.map.learn_more_link}</a></label>
            </div>
            <div className="custom-control custom-checkbox">
          ...
          <div className="form-group">
            <div className="custom-control custom-checkbox">
              ...
              <label className="custom-control-label" htmlFor="keyserverWKDLookup"><span>{l10n.map.keyserver_wkd_lookup}</span>. <a href="https://github.com/imtoiteu/securemail/blob/internal-stable-v1/docs/internal/ADMIN_PUBLIC_KEY_MANAGEMENT_VI.md" target="_blank" rel="noopener noreferrer">{l10n.map.learn_more_link}</a></label>
            </div>
            <div className="custom-control custom-checkbox">
              ...
              <label className="custom-control-label" htmlFor="keyserverAutocryptLookup"><span>{l10n.map.keyserver_autocrypt_lookup}</span>. <a href="https://github.com/imtoiteu/securemail/blob/internal-stable-v1/docs/internal/ADMIN_PUBLIC_KEY_MANAGEMENT_VI.md" target="_blank" rel="noopener noreferrer">{l10n.map.learn_more_link}</a></label>
            </div>
          </div>
          ...
          <div className="form-group">
            <div className="custom-control custom-checkbox">
              ...
              <label className="custom-control-label" htmlFor="keyserverKeyBinding"><span>{l10n.map.keyserver_key_binding_label}</span>. <a href="https://github.com/imtoiteu/securemail/blob/internal-stable-v1/docs/internal/ADMIN_PUBLIC_KEY_MANAGEMENT_VI.md" target="_blank" rel="noopener noreferrer">{l10n.map.learn_more_link}</a></label>
            </div>
          </div>
