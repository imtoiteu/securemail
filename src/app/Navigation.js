  ...
  return (
    <nav className="navbar flex-column fixed-top navbar-expand-md navbar-light bg-white">
      <div className="container-lg py-2">
        <Link to="/dashboard" className="navbar-brand d-inline-flex align-items-center">
          <img src="../img/secure-mail/icon.svg" width="32" height="32" className="d-inline-block align-top mr-2" alt="" />
          <span className="font-weight-bold">Secure Mail</span>
        </Link>
            ...
            <Collapse isOpen={collapse} className="navbar-collapse">
              ...
              <ul className="navbar-nav">
                <li className="nav-item">
                  <a className="nav-link" href="https://github.com/imtoiteu/securemail/tree/internal-stable-v1/docs/internal" target="_blank" rel="noreferrer noopener" tabIndex="0">
