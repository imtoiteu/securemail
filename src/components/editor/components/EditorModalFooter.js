            ...
            <div className="form-group row mb-2">
              ...
              {this.props.extraKey &&
                <div id="extraKeyInput" className="col-sm-8">
                  ...
                  <small className="form-text text-muted"><span>{l10n.map.editor_extra_key_help}</span>. <a href="https://github.com/imtoiteu/securemail/blob/internal-stable-v1/docs/internal/USER_GUIDE_GMAIL_VI.md" target="_blank" rel="noopener noreferrer">{l10n.map.learn_more_link}</a></small>
                </div>
              }
            </div>
          </form>
