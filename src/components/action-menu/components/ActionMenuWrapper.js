      ...
      <div className={`action-menu ${this.state.isSetupDone ? '' : 'action-menu-setup'}`}>
        <div className="action-menu-wrapper card">
          <div className="action-menu-header card-header d-flex">
            <div className="d-inline-flex align-items-center mr-auto"><img src="../../img/secure-mail/icon.svg" width="20" height="20" alt="" /><strong className="ml-2">Secure Mail</strong></div>
            <div className="nav-right">
              ...
              <a href="https://github.com/imtoiteu/securemail/tree/internal-stable-v1/docs/internal" target="_blank" rel="noreferrer noopener" tabIndex="0" title={l10n.map.action_menu_help}><span className="icon icon-help" aria-hidden="true"></span></a>
            </div>
          </div>
          {actionMenuContent}
        </div>
