  ...
  return (
    <div className="file-element" id={file.id} title={file.name}>
      <div className="file-header">
        {(fileExt === 'asc' || fileExt === 'gpg') && <img src="../../img/secure-mail/icon.svg" width="28" height="28" />}
  ...
  return (
    <div className="file-element">
      <a className="file-header" onClick={onClick} title={file.name} download={file.name} href={file.objectURL || '#'}>
        {(fileExt === 'asc' || fileExt === 'gpg' || fileExt === 'pgp') && <img src="../../img/secure-mail/icon.svg" width="28" height="28" />}
        ...
        {file.onShowPopup &&
          <button type="button" className="icon-btn ml-1" title={l10n.map.decrypt_open_viewer_btn_title} onClick={e => { e.preventDefault(); file.onShowPopup(); }}><img src="../../img/secure-mail/icon.svg" width="14" height="14" /></button>
        }
        {file.content &&
